...
class VoiceCallwithVideo extends StatefulWidget {
  const VoiceCallwithVideo({Key? key}): super(key: key);
  @override
  State<StatefulWidget> createState() => _State();
}

class _State extends State<VoiceCallwithVideo> {
  final _users = <int>[];
  RtcEngine? _engine;
  bool isJoined = false;
                  ...
                  Expanded(
                    child: FloatingActionButton(
                      ...
                      GestureDetector(
                          ...
                          child: const Icon(Icons.videocam_off_outlined, color: Colors.white)
                      ),
                    ),
                  ),
                  Expanded(
