...
class BasicVoiceCall extends StatefulWidget {
  const BasicVoiceCall({Key? key}): super(key: key);
  @override
  State<StatefulWidget> createState() => _State();
}

class _State extends State<BasicVoiceCall> {
  final _users = <int>[];
  RtcEngine? _engine;
  bool isJoined = false;
  ...
  void _addAgoraEventHandlers() {
    _engine!.setEventHandler(
      ...
      setState(() {
        stopSound();
        joinMessage = 'Connected to Client';
        _users.add(uid);
      });
